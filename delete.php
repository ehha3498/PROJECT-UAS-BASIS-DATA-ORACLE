...
if (isset($_GET['id_buku'])) {
  ...
  if ($q) {
    ...
    echo "<script>alert('Data berhasil dihapus'); window.location.href='perpustakaan.php'</script>";
  } else {
    // pesan apabila hapus gagal
    echo "<script>alert('Data gagal dihapus'); window.location.href='perpustakaan.php'</script>";
  }
} else {
